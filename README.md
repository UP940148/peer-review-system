...
I think, if I were to do this project again, I would want to spend more time thoroughly planning and testing my API design, because I was still struggling to set one up well at the start of the development process. I would also like to learn how to use CSS better, because one of the main criticisms I got was that the UI needed to be a bit more clear in places, which was down to my layout and how I styled the pages.

I've learned quite a bit about FormData, because I was using it constantly. I felt it was appropriate to use it since pretty much all the data I was handling would be laid out on the page as a form, and therefore it made sense to use FormData over JSON or URL queries.

I also like to think I've learned a lot more about how to structure my code and keep it readable, and therefore maintainable. However I still think I should get some more practice documenting my design ideas because I found myself struggling with it quite a lot throughout development.
